...
class PX4MavCtrler:
    ...
    def __init__(self, ID=1, ip='127.0.0.1', Com='udp', port=0, simulinkDLL=False):
        ...
        #     buf = self.mav0.heartbeat_encode(2, 12,64,0,3).pack(self.mav0)
    ...
    def InitMavLoop(self, UDPMode=2, external=False):
            ...
            if self.UDPMode > 1.5:  # If Use MAVLink Mode
                ...
                if msg is not None:
                    ...
                    if msg.get_type() == "HEARTBEAT":
                        ...
                        # print("msg.custom_mode:",msg.custom_mode)
                        # print(mode)
        ...
        while True:
            ...
            if self.isInOffboard:
                if self.simulinkDLL:
                    ...
                    self.sendMavOffboardAPI(self.type_mask, self.coordinate_frame, self.pos, self.vel, self.acc,
                                            self.yaw, self.yawrate)
